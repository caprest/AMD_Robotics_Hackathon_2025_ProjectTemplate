...
tone_dict = {
    "abemii/d_2nd-20251206_222926": {
        "class": 4,
        "skip": [1, 2, 16],
    },  # 		hatakeyama	20	1,2,16
    "abemii/e_3rd-20251206_223742": {
        "class": 5,
        "skip": [1, 8],
    },  # 		abe	20	1,8
    "abemii/g_2nd-20251206_225240": {
        "class": 7,
        "skip": [1],
    },  # 		hatakeyama	20	1
    "abemii/c_3rd-20251206_230456": {
        "class": 3,
        "skip": [1, 18],
    },  # 		manome	20	1,18
    "abemii/g_3rd-20251206_231711": {
        "class": 7,
        "skip": [1, 2, 13],
    },  # 		abe	20	1,2,13
    "abemii/c_3rd-20251206_232502": {
        "class": 3,
        "skip": [1, 2],
    },  # 		abe	20	1,2
    "abemii/d_3rd-20251206_233236": {
        "class": 4,
        "skip": [1, 8, 17],
    },  # 		hatakeyama	20	1,8,17

    "abemii/e_3rd-20251206_234008": {
        "class": 5,
        "skip": [1, 4, 7],
    }  # 		hatakeyama	20	1,4,7
}
...
NEW_NAME = "abemii/cmaj_scale_dataset_v3"
...
dataset_concat_list = []
for name, tone_info in tone_dict.items():
