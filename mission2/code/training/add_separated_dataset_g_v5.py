...
from lerobot.datasets.dataset_tools import (add_features, delete_episodes,
                                            ...
                                            remove_feature)
from lerobot.datasets.v30.augment_dataset_quantile_stats import augment_dataset_with_quantile_stats
...
for class_name, class_num in classes.items():
    ...
    NEW_NAME = f"abemii/cmaj_scale_dataset_v6_{class_name}"
    ...
    for tone_info in data_list_filtered:
        ...
        dataset = modify_features(
            ...
            #      ),
            #  },
            remove_features=["input.keyboard", "observation.images.stand", "observation.images.light"],
