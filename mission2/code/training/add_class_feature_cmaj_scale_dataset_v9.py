...
NEW_NAME = "abemii/cmaj_scale_dataset_v9"

PREV_FRAMES = 90  # 3 seconds at 30fps (almost all frames before key press)
POST_FRAMES = 10  #  seconds at 30fps (just a little after key press)
