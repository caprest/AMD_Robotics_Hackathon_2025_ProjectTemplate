...
class ActPolicy:
    def __init__(self, note_to_repo_id: dict[str | None, str]):
        self.note_to_policy: dict[str | None, ACTPolicy] = {}
    ...
    def inference(self, observation: dict, note: str) -> torch.Tensor | None:
        ...
        self.prev_note = note
        self.prev_policy = self.note_to_policy[None]
